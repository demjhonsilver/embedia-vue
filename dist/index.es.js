import { ref as h, onMounted as p, watch as f, openBlock as w, createElementBlock as y, normalizeClass as b, normalizeStyle as g, pushScopeId as $, popScopeId as E, createElementVNode as C } from "vue";
let u = 1;
const I = (e, t, o, a) => {
  const r = e.videoUrl, i = _(r);
  if (!i)
  ...
  const a = e.videoUrl, r = k(a), i = e.autoplay ? "1" : "0", n = e.controls ? "1" : "0", c = e.fullscreen ? "1" : "0", s = document.createElement("iframe");
  ...
  const a = e.width || 640, r = e.height || 360, i = e.controls, n = e.autoplay, c = e.loop, s = T(e.videoUrl), l = document.createElement("div");
  ...
  if (!document.querySelector(`#default-style-${t}`)) {
    ...
    a.id = `default-style-${t}`, a.textContent = `
            .${t} {
              display: flex;
  ...
  if (e.clip.includes("youtube.com") || e.clip.includes("youtu.be"))
    N(e, o, t);
  else if (e.clip.includes("facebook.com") || e.clip.includes("fb.com"))
    U(e, o, t);
  else if (e.clip.includes("tiktok.com") || e.clip.includes("tiktok"))
    A(e, o, t);
  else if (e.clip.includes("twitter.com"))
    x(e, o, t);
  else if (e.clip.includes("vimeo.com"))
    V(e, o, t);
  else if (e.clip.includes("dailymotion.com") || e.clip.includes("dailymotion"))
    v(e, o, t);
  else if (e.clip.includes("instagram.com") || e.clip.includes("instagram"))
    I(e, o, t);
  else
...
}, M = (e) => ($("data-v-8d758448"), e = e(), E(), e), q = /* @__PURE__ */ M(() => /* @__PURE__ */ C("div", { class: "video-content" }, null, -1)), j = [
  q
];
...
const W = /* @__PURE__ */ L(B, [["render", z], ["__scopeId", "data-v-8d758448"]]);
export {
  W as EmbediaVue
};
